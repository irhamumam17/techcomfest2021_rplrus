...
public class BookingActivity extends AppCompatActivity {
                ...
                AndroidNetworking.post(Constants.BASE_URL + "/api/booking")
                        ...
                        .getAsJSONObject(new JSONObjectRequestListener() {
                            ...
                            public void onError(ANError error) {
                                Toast.makeText(BookingActivity.this, Constants.TOAST_AN_ERROR, Toast.LENGTH_SHORT).show();
    ...
    public void getTimeSelected() {
        ...
        System.out.println("bookingTimeLength " + bookingTime.length);
    }
